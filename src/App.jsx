  ...
  const createLevels = () => {
    return [
      ...
      },
      {
        ...
        platforms: [[0, 450, 150, 50], [220, 380, 100, 20], [480, 450, 150, 50], [250, 300, 100, 20], [480, 200, 100, 20], [680, 350, 120, 20]],
        coins: [[75, 410], [270, 340], [555, 410], [530, 160], [740, 310]],
        enemies: [[490, 430, 1, 1.5, 480, 630], [490, 180, 1, 1, 480, 580]],
        goal: [730, 300]
      },
      {
        name: "Level 6: Zigzag",
      ...
      },
      {
        ...
        platforms: [[0, 450, 150, 50], [210, 390, 80, 20], [80, 330, 80, 20], [230, 270, 80, 20], [80, 210, 80, 20], [230, 150, 80, 20], [300, 90, 500, 20]],
        coins: [[250, 350], [120, 290], [270, 230], [120, 170], [270, 110], [550, 50]],
        enemies: [[220, 370, 1, 1.2, 210, 290], [90, 310, 1, 1.3, 80, 160]],
        goal: [750, 40]
      },
      {
      ...
      },
      {
        ...
        platforms: [[0, 450, 150, 50], [200, 350, 100, 20], [350, 280, 100, 20], [500, 230, 100, 20], [650, 280, 100, 20], [400, 150, 150, 20]],
        coins: [[250, 310], [400, 240], [550, 190], [700, 240], [475, 110]],
        enemies: [[210, 330, 1, 1.3, 200, 300]],
        goal: [500, 100]
      },
      {
      ...
      },
      {
        ...
        platforms: [[0, 450, 150, 50], [0, 100, 150, 20], [100, 350, 100, 20], [200, 170, 100, 20], [280, 260, 80, 20], [350, 240, 100, 20], [500, 310, 100, 20], [650, 380, 150, 20], [600, 450, 200, 50]],
        coins: [[150, 310], [75, 60], [250, 130], [320, 220], [400, 200], [550, 270], [700, 340]],
      ...
      },
      {
        ...
        platforms: [[0, 450, 120, 50], [150, 400, 70, 20], [250, 350, 70, 20], [350, 300, 70, 20], [500, 250, 15, 20], [350, 200, 70, 20], [250, 150, 70, 20], [150, 100, 70, 20], [250, 50, 70, 20], [400, 50, 400, 20]],
        coins: [[185, 360], [285, 310], [385, 260], [507, 210], [385, 160], [285, 110], [185, 60], [600, 10]],
            ...
            <div className="relative mx-auto max-w-full">
              ...
              <div className="sm:hidden absolute inset-0 pointer-events-none">
                ...
                <button
                  ...
                  className="pointer-events-auto absolute bottom-4 left-4 bg-red-500/60 text-white w-20 h-20 rounded-full font-bold text-lg active:bg-red-700/80 shadow-lg backdrop-blur-sm border-2 border-white/30"
                >
                  JUMP
                </button>
                
                {/* Left/Right arrows - RIGHT SIDE */}
                <div className="pointer-events-auto absolute bottom-4 right-4 flex gap-3">
                  <button
                    ...
                    className="bg-blue-500/60 text-white w-16 h-16 rounded-xl font-bold text-2xl active:bg-blue-700/80 shadow-lg flex items-center justify-center backdrop-blur-sm border-2 border-white/30"
                  >
                    <ArrowLeft size={32} />
                  </button>
                  <button
